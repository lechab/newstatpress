...
function print_textaera($option_title,$option_var,$option_description) {
  echo "<tr><td>\n<p><label for=$option_var>$option_title</label></p>\n";
...
function iriNewStatPressOptions() {
  ...
  print "<div class='wrap'><h2 class='dashicons-before dashicons-admin-generic dash-option'>".__('NewStatPress Settings','newstatpress')."</h2><form method=post>
";
  ...
  if ( $pagenow == 'admin.php' && $_GET['page'] == $page ) {
    ...
    switch ($tab) {
      ...
      <table class='table-option'>
        ...
        echo '<tr><td><h3>Dashboard</h3><td><td></td></tr>';
        ...
        echo '<tr><td><h3>Sécurité</h3><td><td></td></tr>';
      ...
      case 'visits' :
      ?>
      <table class='form-tableH' border='0'>
        <?php
      echo "<tr><th scope='row' rowspan='3'>"; _e('Visitors by Spy','newstatpress'); echo "</th>";
      ...
      echo "<tr><th class='padd' scope='row' rowspan='3'>Spy bot</th>";
    ...
    break;
      ...
      <table class='form-tableH'>
        <?php
        echo "<tr><th class='padd' scope='row' rowspan='4'>Data collecting</th>";
        ...
        echo "<tr><th class='padd' scope='row' rowspan='3'>Data purging</th>";
      ...
      <table class='form-tableH'>
        <?php
                ...
                // echo '<tr><td><h3>Element numbers in:</h3><td><td></td></tr>';
